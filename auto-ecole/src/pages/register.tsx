...
const Register: React.FC = () => {
  ...
  function Change_Ecole() {
    var x = document.getElementById("show-ecole");
  ...
  function Change_Nouveau() {
    var y = document.getElementById("show-nouveau");
    ...
    <div>
      ...
      <main>
        ...
        <div className={styles.oui}>
          <p>{registerError}</p>
          <button onClick={() => Change_Ecole()}>Register AutoEcole</button>
          <button onClick={() => Change_Nouveau()}>Register nouveau client</button>
          <form id="auto-ecole" onSubmit={ (e) => registerAutoEcole(e, setRegister, setRegisterError, setToken, selectedFile) }>
            <div id="show-ecole" className={styles.hidden}>
